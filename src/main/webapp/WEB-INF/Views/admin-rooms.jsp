...
<head>
    ...
    <title>Room Management - Hopital Numerique</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="<%= request.getContextPath() %>/admin/rooms" class="active">Rooms</a></li>
    ...
    <div class="main-container">
        <div class="page-header">
            ...
            <button class="btn btn-primary" onclick="showCreateModal()">Add New Room</button>
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button class="btn btn-secondary" onclick="editRoom(<%= room.getId() %>, '<%= room.getName() %>', <%= room.getCapacity() %>)">
                                        Edit
                                    </button>
                                    <form method="post" action="<%= request.getContextPath() %>/admin/rooms" style="display: inline;">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="<%= request.getContextPath() %>/admin/rooms">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="createCapacity" name="capacity" min="1" required>
                </div>
